...
function expandChunkKomodo(chunk_index) {
    document.getElementById('chunk.{{forloop.counter}}').style.display = '';
    document.getElementById('chunk-collapse.{{forloop.counter}}').style.display = '';
    document.getElementById('chunk-expand.{{forloop.counter}}').style.display = 'none';
}

function collapseChunkKomodo(chunk_index) {
    document.getElementById('chunk.{{forloop.counter}}').style.display = 'none';
    document.getElementById('chunk-collapse.{{forloop.counter}}').style.display = 'none';
    document.getElementById('chunk-expand.{{forloop.counter}}').style.display = '';
}
